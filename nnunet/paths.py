...
try:
    ...
    #base = "/drive/My Drive/nnUNet-master/nnunet/base"
    #base = os.environ['nnUNet_base']
    base = "/content/nnUNet/nnunet/base"
...
try:
    ...
    # different systems (and our compute cluster). You can replace this line with something like:
    #preprocessing_output_dir = "/drive/My Drive/nnUNet-master/nnunet/ResultData/Preprocess"
    preprocessing_output_dir = "/content/nnUNet/nnunet/Preprocess"
...
try:
    # Here I use environment variables to set the folder. Environment variables allow me to use the same code on
    # different systems (and our compute cluster). You can replace this line with something like:
    #network_training_output_dir = "/drive/My Drive/nnUNet-master/nnunet/ResultData"
    network_training_output_dir = "/content/nnUNet/nnunet/ResultData"
